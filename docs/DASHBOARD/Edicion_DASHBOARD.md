...
| 14 | Canvas del dashboard | Área de trabajo | Edita dashboard | Permite al usuario diseñar y organizar visualmente el dashboard añadiendo widgets y configurando variables. Para utilizarlo, el usuario debe arrastrar elementos al canvas y posicionarlos según sus necesidades. |
