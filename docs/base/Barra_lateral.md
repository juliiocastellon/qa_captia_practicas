# 🖥️ Menú de Navegación Principal – Captia.ai

**Objetivo Principal:** Permite al usuario acceder a todas las secciones funcionales de la plataforma Captia.ai desde un panel de navegación lateral persistente.
...
[← Anterior](./barra_superior.md) • [📚 Índice](../README.md) • [Siguiente →](../widgets/widget.md)
