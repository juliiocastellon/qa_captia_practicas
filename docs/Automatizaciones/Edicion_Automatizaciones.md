...
| 12 | Categoría "Nodos del workflow" | Categoría de biblioteca | Mostrar nodos | [Configuración](./configuracion/Nodos_Workflow.md) | Permite al usuario visualizar los nodos estándar disponibles para construir automatizaciones dentro del canvas. Para utilizarlo, el usuario debe abrir la categoría y arrastrar los nodos deseados al área de trabajo. |
| 13 | Categoría "Catálogo UDT" | Categoría de biblioteca | Mostrar catálogo UDT | [Configuración](./configuracion/Catalogo_UDT.md) | Permite al usuario acceder a nodos y elementos basados en definiciones UDT para automatizaciones avanzadas. Para utilizarlo, el usuario debe abrir la categoría y seleccionar los elementos que desea utilizar en el workflow. |
| 14 | Categorías de nodos | Listado de categorías | Filtrar nodos | [Configuración](./configuracion/Categorias_Nodos.md) | Permite al usuario organizar y localizar nodos según categorías funcionales como triggers, acciones, variables o monitorización. Para utilizarlo, el usuario debe seleccionar la categoría correspondiente para visualizar los nodos relacionados. |
