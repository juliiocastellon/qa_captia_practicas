...
| 11 | Atajos de teclado | Panel contextual | Ver atajos | Permite al usuario consultar los atajos de teclado disponibles para agilizar la edición y navegación dentro del editor de workflows. Para utilizarlo, el usuario debe abrir el panel de atajos y revisar las co
mbinaciones disponibles. |
