...
| 1 | Variable UDT | Opción seleccionable | Abre configuración de Variable UDT | [Configuración](./Configuración/variable_udt.md) | Construye una estructura de datos tipada (UDT) mapeando variables globales del proceso. |
