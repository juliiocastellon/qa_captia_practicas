...
| 3.9.1 | Series Avanzadas | Elemento seleccionable | Inserta un gráfico de series con doble eje Y y referencias | [Configuración](./Configuracion/avanzados/Series.md) | Úsalo cuando necesites comparar en un mismo gráfico variables con unidades o escalas muy distintas, o cuando quieras marcar visualmente umbrales y objetivos sobre la evolución temporal. |
...
[← Anterior](./widgetsAnalytics_formas_escada.md) • [📚 Índice](../README.md) • [Siguiente →](./widgetsScada_basicos.md)
