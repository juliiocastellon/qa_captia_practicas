...
El widget **Dona** está diseñado para representar distribuciones porcentuales mediante gráficos circulares con espacio central libre.
...
- Mostrar valores centrales destacados

## ✅ Cómo configurar correctamente el widget Dona
...
3. Desde el panel de propiedades:
   ...
   - Personaliza el contenido central.
