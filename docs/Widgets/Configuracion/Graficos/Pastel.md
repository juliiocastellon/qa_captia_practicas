...
<img width="1302" height="723" alt="image" src="https://github.com/user-attachments/assets/143855c4-03bc-49e8-91be-8d43bb77252f" />
...
| 2.1 | Sección "Contenedor" | Configuración visual | Ajusta apariencia del widget | Permite modificar el estilo del contenedor del gráfico, incluyendo fondo, bordes y transparencia. Para utilizarlo, el usuario debe seleccionar el estilo visual y ajustar colores y opacidad. |
| 2.2 | Sección "Opciones de gráfico" | Configuración funcional | Ajusta visualización | Permite configurar leyendas, cuadrículas y tooltips del gráfico. Para utilizarlo, el usuario puede activar o desactivar cada opción según el diseño deseado. |
...
| 2.4 | Sección "Grosor y tamaño" | Configuración visual | Ajusta elementos gráficos | Permite configurar el grosor de líneas, tamaño de puntos y radios visuales del gráfico. Para utilizarlo, el usuario debe mover los sliders hasta conseguir la visualización deseada. |
...
El widget **Pastel** está diseñado para representar distribuciones porcentuales mediante divisiones circulares.
...
- Analizar repartos de datos
- Mostrar composiciones visuales
- Facilitar interpretación rápida

## ✅ Cómo configurar correctamente el widget Pastel

1. Arrastra el widget al canvas.
2. Selecciona el gráfico dentro del dashboard.
3. Desde el panel de propiedades:
   - Configura categorías y valores.
   - Ajusta colores y etiquetas.
   - Personaliza leyendas y tamaños.
   - Configura tooltips y porcentajes visibles.
